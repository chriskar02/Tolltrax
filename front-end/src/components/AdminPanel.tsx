...
export default function AdminPanel() {
  ...
  const resetStations = async () => {
    ...
    setMessage(null)
    try {
      const response = await axios.post("http://localhost:3000/admin/resetstations")
  ...
  const resetPasses = async () => {
    ...
    setMessage(null)
    try {
      const response = await axios.post("http://localhost:3000/admin/resetpasses")
  ...
  const addPasses = async () => {
    ...
    setMessage(null)
    try {
      const response = await axios.post("http://localhost:3000/admin/addpasses")
      setMessage(
  ...
  const performHealthcheck = async () => {
    ...
    setHealthData(null)
    try {
      const response = await axios.get("http://localhost:3000/admin/healthcheck")
  ...
  const resetUsers = async () => {
    ...
    setMessage(null)
    try {
      const response = await axios.post("http://localhost:3000/admin/resetusers")
  ...
  const resetVehicles = async () => {
    ...
    setMessage(null)
    try {
      const response = await axios.post("http://localhost:3000/admin/resetvehicles")
